...
class ChamferLossLayer(Layer):
    ...
    def call(self, cloud1, cloud2):
        ...
        # returns the sum of (the mean, minimum, squared distance from cloud 1 to 2) and vica
        #   (the mean, minimum, squared distance from cloud 2 to 1)
        cham_distance = chamfer_distance.evaluate(cloud1, cloud2)
